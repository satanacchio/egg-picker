export const BASE_URL: string = 'https://dragcave.net';
export const LOGIN_URL: string = 'https://dragcave.net/login';
export const ENVIRONMENTS: Map<string, string> = new Map([
